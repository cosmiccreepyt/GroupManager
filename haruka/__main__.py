...
I'm group manager bot and Anti-spam for  ЯΛҜΠ͢͢Ө


Activate Anti-spam protection in your PM by this command : 
/antispam on 

Made from the source code of [DARKCODER 🇮🇳](t.me/LOVE2DWORLD)


Click /help or Help button below to find out more about how to use me to my full potential.

 Add me to a group by clicking [here](http://t.me/NekoManager_Bot?startgroup=true).
"""
